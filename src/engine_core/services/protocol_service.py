...
class ProtocolService:
    ...
    async def list_protocols(self, project_id: str, status_filter: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    async def get_protocol(self, project_id: str, protocol_id: str) -> Optional[Dict[str, Any]]:
    ...
    async def create_protocol(self, project_id: str, id: str, name: str,
                            description: Optional[str] = None,
                            commands: Optional[List[Dict[str, Any]]] = None,
                            execution_order: Optional[List[str]] = None) -> Dict[str, Any]:
    ...
    async def update_protocol(self, project_id: str, protocol_id: str, **update_data) -> Dict[str, Any]:
