...
class AgentCreateSchema(BaseModel):
    ...
    speciality: str = Field(
        ..., min_length=1, max_length=500, description="Agent speciality"
    )
    persona: str = Field(
        ..., min_length=1, max_length=1000, description="Agent persona description"
    )
...
class AgentUpdateSchema(BaseModel):
    ...
    speciality: Optional[str] = Field(
        default=None, min_length=1, max_length=500, description="Agent speciality"
    )
...
class AgentBackupSchema(BaseModel):
    ...
    agent_id: str = Field(..., description="Agent ID")
    backup_date: datetime = Field(
        default_factory=datetime.utcnow, description="Backup date"
    )
