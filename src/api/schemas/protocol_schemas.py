...
from .enums import ProtocolType, CommandType, ParameterType
...
class ProtocolCommandSchema(BaseModel):
    ...
    semantic_patterns: List[str] = Field(default_factory=list, description="Semantic patterns")
...
class ProtocolUpdateSchema(BaseModel):
    ...
    configuration: Optional[Dict[str, Any]] = Field(default=None, description="Protocol configuration")
