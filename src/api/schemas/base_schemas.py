...
class ConfigSchema(BaseModel):
    ...
    required: bool = Field(default=False, description="Whether configuration is required")
...
class SearchQuerySchema(BaseModel):
    ...
    filters: Optional[List[FilterSchema]] = Field(default=None, description="Search filters")
    sort: Optional[SortSchema] = Field(default=None, description="Search sorting")
    pagination: Optional[PaginationSchema] = Field(default=None, description="Search pagination")
